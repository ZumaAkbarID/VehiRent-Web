    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8 ftco-animate">
          ...
          <p>
            <img src="assets/main/images/image_7.jpg" alt="" class="img-fluid">
          </p>
          ...
          <p>
            <img src="assets/main/images/image_8.jpg" alt="" class="img-fluid">
          </p>
          ...
          <div class="about-author d-flex p-4 bg-light">
            <div class="bio mr-5">
              <img src="assets/main/images/person_1.jpg" alt="Image placeholder" class="img-fluid mb-4">
            </div>
            <div class="desc">
          ...
          <div class="pt-5 mt-5">
            ...
            <ul class="comment-list">
              <li class="comment">
                <div class="vcard bio">
                  <img src="assets/main/images/person_1.jpg" alt="Image placeholder">
                </div>
