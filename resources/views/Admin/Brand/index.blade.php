...
@section('dashboard')
    <ul class="nav nav-pills flex-column flex-md-row mb-3">
        <li class="nav-item">
            <button class="nav-link active" onclick="createForm()" id="#modalDialogBtn"><i class="bx bx-user me-1"></i> Create New Brand</button>
        </li>
    </ul>
    <!-- Responsive Table -->
    <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-lg-6">
                    <h5 class="d-inline">Manage Brand</h5>
